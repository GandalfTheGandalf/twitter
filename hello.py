...
SECRET_KEY = 'RsRXQR7lIemd4mPhqIX8UCIySZUHso9svaYMyfevBy1IANecKd'
DEBUG = True
...
twitter = oauth.remote_app('twitter',
    ...
    consumer_key='TZWCDWpHMUgouvstY6JUQBAnU',
    consumer_secret='RsRXQR7lIemd4mPhqIX8UCIySZUHso9svaYMyfevBy1IANecKd'
)
